...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/03 23:33:46 by ddowty            #+#    #+#             */
/*   Updated: 2016/12/23 16:35:32 by ddowty           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				*ft_memjoin(const void *p1, const void *p2,
	size_t l1, size_t l2);
void				*ft_memjoin_free(void *p1, void *p2,
	size_t l1, size_t l2);
...
void				ft_lstdel(t_list **alst, void (*dle)(void *, size_t));
